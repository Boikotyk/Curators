...
<head>
	...
	<title>Curaters - Онлайн підтримка кураторів</title>
...
<body>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="top-link">
                                <ul class="link">
                                    ...
                                    <li><a href="/logout.php"><i class="fa fa-share"></i>Вихід</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
	...
	<section id="home" class="pfblock-image screen-height">
		...
		<div class="intro">
			...
			<h1>Ткачук Валерій Михайлович</h1>
		...
		<nav class="navbar navbar-custom" role="navigation">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="">Ткачук Валерій Михайлович</a>
				</div>
   ...
   if(isset($_POST["last_name"])){
                ...
                if(!empty($last_name)){
                    ...
                    echo $last_name = htmlspecialchars($last_name, ENT_QUOTES);
                }else{
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12">
                    ...
                    <p class="copyright">
                        © 2021 Розроблено Миколою Шекеряком для <a href=""> дипломної роботи</a>
					</p>
