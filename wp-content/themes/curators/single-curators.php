        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="top-menu">
                        <p class="welcome-msg"><a href="/"><?php _e('Ми раді вас бачити'); ?></a> </p>
                    </div>
                	<div class="top-link">
                        <ul class="link">
                            <li><a href="/"> <i class="fa fa-home"></i><?php _e('На головну'); ?></a></li>
                            <?php 
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="custom-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="#services">Інформація</a></li>
                        <li><a href="#portfolio">Групи</a></li>
                        <li><a href="#skills">Дисципліни</a></li>
	...
	<section id="services" class="pfblock pfblock-gray">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="pfblock-header wow fadeInUp">
						<h2 class="pfblock-title">Інформація про куратора</h2>
						<div class="pfblock-line"></div>
						<div class="pfblock-subtitle">
							ПОСАДА:</br>
							Доцент кафедри інформаційних технологій</br>
							НАУКОВИЙ СТУПІНЬ:</br>
							Кандидат фіз.-мат. наук, спеціальність 01.04.18 – фізика і хімія поверхні, 2001 р.</br>
							ВЧЕНЕ ЗВАННЯ:</br>
							Доцент кафедри інформатики, 2007 р.</br>    
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div id="myBtn1" class="col-sm-4">
					<div class="iconbox wow slideInLeft">
						<div class="iconbox-icon">
							<span class="icon-magic-wand"></span>
						</div>
						<div class="iconbox-text">
							<h3 class="iconbox-title">Освіта</h3>
							<div class="iconbox-desc">
								Наведену основну інформацію про дану категорію
							</div>
						</div>
					</div>
				</div>
				...
				<div id="myModal1" class="modal">
				  	...
				  	<div class="modal-content">
				    	...
				    	<p>це модалка освіти</p>
				  	</div>
				</div>
				<div id="myBtn2" class="col-sm-4">
					<div class="iconbox wow desliInLeft">
						<div class="iconbox-icon">
							<span class="icon-puzzle"></span>
						</div>
						<div class="iconbox-text">
							<h3 class="iconbox-title">Викладацька робота</h3>
							<div class="iconbox-desc">
								Наведену основну інформацію про дану категорію
							</div>
						</div>
				...
				<div id="myModal2" class="modal">
				  	...
				  	<div class="modal-content">
				    	...
				    	<p>це модалка Викладацька</p>
				  	</div>
				</div>
				<div id="myBtn3" class="col-sm-4">
					<div class="iconbox wow desliInLeft">
						<div class="iconbox-icon">
							<span class="icon-badge"></span>
						</div>
						<div class="iconbox-text">
							<h3 class="iconbox-title">Стажування</h3>
							<div class="iconbox-desc">
								Наведену основну інформацію про дану категорію
							</div>
						</div>
				...
				<div id="myModal3" class="modal">
				  	...
				  	<div class="modal-content">
				    	...
				    	<p>це модалка Стажування</p>
				  	</div>
				</div>
				<div id="myBtn4" class="col-sm-4">
					<div class="iconbox wow slideInRight">
						<div class="iconbox-icon">
							<span class="icon-question"></span>
						</div>
						<div class="iconbox-text">
							<h3 class="iconbox-title">Членство у професійних об'єднаннях</h3>
							<div class="iconbox-desc">
								Наведену основну інформацію про дану категорію
							</div>
						</div>
				...
				<div id="myModal4" class="modal">
				  	...
				  	<div class="modal-content">
				    	...
				    	<p>це модалка професійних</p>
				  	</div>
				</div>
				<div id="myBtn5" class="col-sm-4">
					<div class="iconbox wow slideInRight">
						<div class="iconbox-icon">
							<span class="icon-question"></span>
						</div>
						<div class="iconbox-text">
							<h3 class="iconbox-title">Наукова діяльність</h3>
							<div class="iconbox-desc">
								Наведену основну інформацію про дану категорію
							</div>
						</div>
				...
				<div id="myModal5" class="modal">
				  	...
				  	<div class="modal-content">
				    	...
				    	<p>це модалка діяльність</p>
				  	</div>
				</div>
				<div id="myBtn6" class="col-sm-4">
					<div class="iconbox wow slideInRight">
						<div class="iconbox-icon">
							<span class="icon-question"></span>
						</div>
						<div class="iconbox-text">
							<h3 class="iconbox-title">Контакти</h3>
							<div class="iconbox-desc">
								Наведену основну інформацію про дану категорію
							</div>
						</div>
				...
				<div id="myModal6" class="modal">
				  	...
				  	<div class="modal-content">
				    	...
				    	<p>Кафедра інформаційних технологій, ауд. 319, адміністративний корпус
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-sm-offset-3">
					...
					<div class="pfblock-header wow fadeInUp">
						<h2 class="pfblock-title">Навчальні групи</h2>
						<div class="pfblock-line"></div>
						<div class="pfblock-subtitle">
							Навчальні групи у яких користувач веде пари
						</div>
					</div>
				                ...
				                <div class="col-xs-12 col-sm-4 col-md-4">
				                    <div class="grid wow zoomIn">
				                        <figure class="effect-bubba">
				                            <?php echo get_the_post_thumbnail(get_the_ID(), 'post_540x280',array('class' => '',)); ?>
				                            <figcaption>
				                                <h2><?php echo get_the_title(); ?></h2>
				                                <p>Коротка інформаці групи:</br>Кількість студентів:<span>1</span></br> Староста: <span>1</span> </p>
				                            </figcaption>			
				                        </figure>
				                    </div>
				                </div>
				...
				<div class="row skills">
					...
					<div class="row">
                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                            ...
                            <div class="pfblock-header wow fadeInUp">
                                <h2 class="pfblock-title">Навчальні дисципліни керівника</h2>
                                <div class="pfblock-line"></div>
                                <div class="pfblock-subtitle">
                                    Навчальні дисципліни які викладає викладач
                                </div>
                            </div>
            ...
            <div class="row">
				<div class="col-sm-6 col-sm-offset-3">
					<div class="pfblock-header wow fadeInUp">
						...
						<div class="pfblock-line"></div>
						<div class="pfblock-subtitle">
							група з студентами(їх ПІБ, дані проживання, пошта, звіт оцінювання)
						</div>						
					</div>
				</div>
			</div><!-- .row -->
			...
			<div class="row">
				...
				<div class="col-sm-6 col-sm-offset-3">
					...
					<div class="pfblock-header">
						<h2 class="pfblock-title">ЧЕРКНІТЬ МЕНІ КІЛЬКА РЯДКІВ</h2>
						<div class="pfblock-line"></div>
						<div class="pfblock-subtitle">
